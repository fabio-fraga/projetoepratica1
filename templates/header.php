...
<body>
  ...
  <div id="div-opcoes">
    ...
    <?php if (isset($_SESSION['login'])): ?>
      <li class="li-header"><a href="logout.php" class="a-header">Sair</a></li>
    ...
    <?php endif ?>
	  ...
	  <li class="li-header"><a href="https://github.com/FabioMouradeFraga/projetoepratica1" target="_blank" class="a-header">GitHub</a>
    </li>
